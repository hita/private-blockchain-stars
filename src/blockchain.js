...
class Blockchain {
    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            let previousBlock = self.chain[chainHeight];
            let currentBlock = block;

            currentBlock.height = chainHeight + 1;
     ...
     * sign it with your Bitcoin Wallet 
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (maxTime >= currentTime - messageTime){
                ...
                reject (Error(`Timeout ${maxTime} ms`));
            }
        });
    }
    ...
    validateChain() {
        ...
        return new Promise(async (resolve, reject) => {
            self.chain.forEach( block => { 
                if (!block.validate()) { 
                    errorLog.push({block: block, error: "invalid block"});
                }
